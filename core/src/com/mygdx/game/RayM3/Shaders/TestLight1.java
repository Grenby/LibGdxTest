package com.mygdx.game.RayM3.Shaders;
...
import com.mygdx.game.RayM3.Sh.MyCam;
...
public class TestLight1 implements Screen, InputProcessor {
    ...
    public boolean keyDown(int keycode) {
        switch (keycode){
            case com.badlogic.gdx.Input.Keys.W:move[0]+=1;break;
            case com.badlogic.gdx.Input.Keys.S:move[0]-=1;break;
            case com.badlogic.gdx.Input.Keys.A:move[2]-=1;break;
            case com.badlogic.gdx.Input.Keys.D:move[2]+=1;break;
        }
        return false;
    }
